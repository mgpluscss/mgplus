...
const DropdownSection:Component = ()=>     <section id="dropdown">
<h2>Dropdown</h2>

<div class="mg-dropdown" data-value="bmw" id="dropdown-example">
  <button data-toggle="dropdown" class="mg-dropdown--button">
    Choose Action
  </button>
  <div class="mg-dropdown--content mg-dropdown--content-right mg-nav">
    <ul>
